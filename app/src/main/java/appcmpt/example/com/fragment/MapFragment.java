...
import appcmpt.example.com.fast4.DataDriverId;
import appcmpt.example.com.fast4.DataUserAge;
import appcmpt.example.com.fast4.DirectionsJSONParser;
import appcmpt.example.com.fast4.GPSTracker;
import appcmpt.example.com.fast4.R;

import static appcmpt.example.com.fast4.NetworkChecker.isConnected;
import static appcmpt.example.com.fast4.NetworkChecker.isConnectedMobile;
import static appcmpt.example.com.fast4.NetworkChecker.isConnectedWifi;
	...
	public void onClick(View v) {
		...
		if (s != null) {
			...
			try {
				...
				DataDriverId.getInstance().setDistributor_id(driverId);
